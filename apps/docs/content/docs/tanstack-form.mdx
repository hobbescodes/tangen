...
By default, Tangrams uses Zod for validation, but you can also use [Valibot, ArkType, or Effect](/docs#validator-libraries) by setting the `validator` option in your config.
